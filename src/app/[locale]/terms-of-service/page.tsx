  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <p>
          Welcome to {appName}. These terms and conditions outline the rules and regulations for the
          use of our website and services.
        </p>
        <p>
          By accessing this website, we assume you accept these terms and conditions in full. Do not
          continue to use {appName} if you do not accept all of the terms and conditions stated on
          this page.
        </p>
        ...
        <p>
          ...
          rights for all material on {appName}. All intellectual property rights are reserved.
        </p>
        <p>
        ...
        <ul className="list-disc pl-6 my-4 space-y-2">
          ...
          <li>
            Redistribute content from {appName} (unless content is specifically made for
            redistribution)
          </li>
        </ul>
        ...
        <p>
          {appName} offers various subscription plans for our invoicing services. By selecting a
          subscription plan, you agree to pay the specified fees. Billing will occur on a recurring
          basis, depending on the billing cycle you select when purchasing a subscription.
        </p>
        <p>
          You may cancel your subscription at any time. Upon cancellation, you will continue to have
          access to the service through the end of your billing period.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">5. Free Trial</h2>
        <p>
          {appName} may, at its sole discretion, offer a subscription with a free trial for a
          limited period of time. You may be required to enter your billing information to sign up
          for the free trial.
        </p>
        <p>
          If you do not cancel your subscription before the end of the free trial period, you will
          be automatically charged the applicable subscription fee for the type of subscription you
          have selected.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">6. Limitation of Liability</h2>
        <p>
          In no event shall {appName}, nor its directors, employees, partners, agents, suppliers, or
        ...
        <p className="mt-2">
          <strong>Email:</strong> terms@billeasy.com
          <br />
