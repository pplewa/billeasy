    ...
    <InvoiceLayout data={data}>
      <div className="relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          {/* From section */}
          <div>
            <h3 className="text-sm font-medium uppercase text-purple-600 mb-3 border-b border-purple-200 pb-1">
              From
            </h3>
      ...
      {/* Items table */}
      <div className="mb-10">
        <h3 className="text-sm font-medium uppercase text-purple-600 mb-4 border-b border-purple-200 pb-2">
          Items
        </h3>
      ...
      {(details?.additionalNotes || details?.paymentTerms) && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          {details?.additionalNotes && (
            <div>
              <h3 className="text-sm font-medium uppercase text-purple-600 mb-2 border-b border-purple-200 pb-1">
                Notes
              </h3>
            ...
            <div className="max-w-xs">
              {details.signature.data.startsWith("data:image") ? (
                ...
                <p
                  ...
                  style={{
                    fontFamily: details.signature.fontFamily || undefined,
                  }}
                >
                  {details.signature.data}
                </p>
