...
const fieldValidators = {
  ...
  // Items
  quantity: z.coerce.number().min(1, { message: 'Must be a number greater than 0' }).optional(),
  unitPrice: z.coerce.number().min(1, { message: 'Must be a number greater than 0' }).optional(),
